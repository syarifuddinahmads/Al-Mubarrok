            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 100px;"><img src="{{asset('assets/images/small/img-2.jpg')}}" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{asset('assets/images/small/img-6.jpg')}}" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{asset('assets/images/small/img-1.jpg')}}" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
                            ...
                            <tr>
                                <td><img src="{{asset('assets/images/small/img-2.jpg')}}" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
